...
public:
    ...
    {
        // VITALIYT:
        // Using memcpy-based Read overload to avoid alignment issues on 32-bit ARM devices
        _input.Read(&value, sizeof(value));
    }
...
public:
    ...
    {
        // VITALIYT:
        // Using memcpy-based Write overload to avoid alignment issues on 32-bit ARM devices
        _output.Write(&value, sizeof(value));
    }
